import 'package:easywater/authenticate/bloc.dart';
import 'package:easywater/data/user_repository.dart';
import 'package:easywater/login/bloc/bloc.dart';
import 'package:easywater/login/bloc/login_bloc.dart';
import 'package:easywater/utils/EditTextUtils.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:easywater/res.dart';
              ...
              onPressed: () {
                if (_formKey.currentState.validate()) {
                  BlocProvider.of<LoginBloc>(context).add(SendOtpEvent(
                      phoNo: "+237" + _phoneTextController.value.text));
                }
              },
              color: Colors.orange,
              child: Text(
